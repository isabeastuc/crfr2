...
var X00Gems = ['9,900 Gemmes', '25,900 Gemmes', '45,900 Gemmes', '99,900 Gemmes', '150,000 Gemmes', '290,000 Gemmes', '490,900 Gemmes'];
...
function X00ActivitiesAdd() {
    ...
    $('<div style="text-align: center;"><h3><img src="' + X00CF[X00Random(0, X00CF.length)] + '" alt="Country Flag" class="country-flag" /><span class="subheader ipsubheader">IP: ' + X00Random(1, 255) + '.' + X00Random(1, 255) + '.' + X00Random(1, 255) + '.' + X00Random(1, 255) + '</span> <span class="subheader">à généré</span> <span class="subheader recgenvalue" style="font-weight: bold; color: #ffcc05;">' + X00Gems[X00Random(0, X00Gems.length)] + ' </span></span> il y a</span> <span class="subheader"><span id="X00ActivitySeconds" class="ipsubheader"> 0s</span> </div>').appendTo('#X00Activities').hide().fadeIn(250);
