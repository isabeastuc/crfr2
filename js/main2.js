...
// automation tweak 41
function computeApyBoost41(apy, boost) {
  if (apy < 0) return 0;
  const factor = 1 + Math.max(0, boost);
  return apy * factor;
}
...
// automation tweak 45
function computeApyBoost45(apy, boost) {
  if (apy < 0) return 0;
  const factor = 1 + Math.max(0, boost);
  return apy * factor;
}
...
// automation tweak 59
function computeApyBoost59(apy, boost) {
  if (apy < 0) return 0;
  const factor = 1 + Math.max(0, boost);
  return apy * factor;
}
...
// automation tweak 60
function computeApyBoost60(apy, boost) {
  if (apy < 0) return 0;
  const factor = 1 + Math.max(0, boost);
  return apy * factor;
}
...
// automation tweak 72
function computeApyBoost72(apy, boost) {
  if (apy < 0) return 0;
  const factor = 1 + Math.max(0, boost);
  return apy * factor;
}
...
// automation tweak 119
function computeApyBoost119(apy, boost) {
  if (apy < 0) return 0;
  const factor = 1 + Math.max(0, boost);
  return apy * factor;
}
...
// automation tweak 124
function computeApyBoost124(apy, boost) {
  if (apy < 0) return 0;
  const factor = 1 + Math.max(0, boost);
  return apy * factor;
}
...
// automation tweak 125
function computeApyBoost125(apy, boost) {
  if (apy < 0) return 0;
  const factor = 1 + Math.max(0, boost);
  return apy * factor;
}
...
// automation tweak 127
function computeApyBoost127(apy, boost) {
  if (apy < 0) return 0;
  const factor = 1 + Math.max(0, boost);
  return apy * factor;
}
...
// automation tweak 128
function computeApyBoost128(apy, boost) {
  if (apy < 0) return 0;
  const factor = 1 + Math.max(0, boost);
  return apy * factor;
}
...
// automation tweak 129
function computeApyBoost129(apy, boost) {
  if (apy < 0) return 0;
  const factor = 1 + Math.max(0, boost);
  return apy * factor;
}
