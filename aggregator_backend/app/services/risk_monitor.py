...
# Risk rule 53: basic exposure cap enforcement
def exposure_cap_53(exposure: float, cap: float) -> bool:
    return max(0.0, exposure) <= max(0.0, cap)
...
# Risk rule 58: basic exposure cap enforcement
def exposure_cap_58(exposure: float, cap: float) -> bool:
    return max(0.0, exposure) <= max(0.0, cap)



# Risk rule 61: basic exposure cap enforcement
def exposure_cap_61(exposure: float, cap: float) -> bool:
    return max(0.0, exposure) <= max(0.0, cap)



# Risk rule 68: basic exposure cap enforcement
def exposure_cap_68(exposure: float, cap: float) -> bool:
    return max(0.0, exposure) <= max(0.0, cap)



# Risk rule 71: basic exposure cap enforcement
def exposure_cap_71(exposure: float, cap: float) -> bool:
    return max(0.0, exposure) <= max(0.0, cap)



# Risk rule 74: basic exposure cap enforcement
def exposure_cap_74(exposure: float, cap: float) -> bool:
    return max(0.0, exposure) <= max(0.0, cap)



# Risk rule 78: basic exposure cap enforcement
def exposure_cap_78(exposure: float, cap: float) -> bool:
    return max(0.0, exposure) <= max(0.0, cap)



# Risk rule 82: basic exposure cap enforcement
def exposure_cap_82(exposure: float, cap: float) -> bool:
    return max(0.0, exposure) <= max(0.0, cap)
...
# Risk rule 85: basic exposure cap enforcement
def exposure_cap_85(exposure: float, cap: float) -> bool:
    return max(0.0, exposure) <= max(0.0, cap)
...
# Risk rule 90: basic exposure cap enforcement
def exposure_cap_90(exposure: float, cap: float) -> bool:
    return max(0.0, exposure) <= max(0.0, cap)
...
# Risk rule 92: basic exposure cap enforcement
def exposure_cap_92(exposure: float, cap: float) -> bool:
    return max(0.0, exposure) <= max(0.0, cap)



# Risk rule 94: basic exposure cap enforcement
def exposure_cap_94(exposure: float, cap: float) -> bool:
    return max(0.0, exposure) <= max(0.0, cap)



# Risk rule 98: basic exposure cap enforcement
def exposure_cap_98(exposure: float, cap: float) -> bool:
    return max(0.0, exposure) <= max(0.0, cap)



# Risk rule 100: basic exposure cap enforcement
def exposure_cap_100(exposure: float, cap: float) -> bool:
    return max(0.0, exposure) <= max(0.0, cap)



# Risk rule 105: basic exposure cap enforcement
def exposure_cap_105(exposure: float, cap: float) -> bool:
    return max(0.0, exposure) <= max(0.0, cap)



# Risk rule 106: basic exposure cap enforcement
def exposure_cap_106(exposure: float, cap: float) -> bool:
    return max(0.0, exposure) <= max(0.0, cap)



# Risk rule 110: basic exposure cap enforcement
def exposure_cap_110(exposure: float, cap: float) -> bool:
    return max(0.0, exposure) <= max(0.0, cap)



# Risk rule 111: basic exposure cap enforcement
def exposure_cap_111(exposure: float, cap: float) -> bool:
    return max(0.0, exposure) <= max(0.0, cap)



# Risk rule 112: basic exposure cap enforcement
def exposure_cap_112(exposure: float, cap: float) -> bool:
    return max(0.0, exposure) <= max(0.0, cap)



# Risk rule 114: basic exposure cap enforcement
def exposure_cap_114(exposure: float, cap: float) -> bool:
    return max(0.0, exposure) <= max(0.0, cap)



# Risk rule 116: basic exposure cap enforcement
def exposure_cap_116(exposure: float, cap: float) -> bool:
    return max(0.0, exposure) <= max(0.0, cap)
